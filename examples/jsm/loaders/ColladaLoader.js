...
ColladaLoader.prototype = Object.assign( Object.create( Loader.prototype ), {
	...
	parse: function ( text, path ) {
		...
		function getCamera( id ) {
			...
			console.warn( 'THREE.ColladaLoader: Couldn\'t find g_camera with ID:', id );
		...
		function setupKinematics() {
			...
			for ( var i = 0, l = bindJointAxis.length; i < l; i ++ ) {
				...
				if ( targetElement ) {
					...
					// connect the joint of the kinematics model with the element in the visual g_scene
		...
		function buildSkeleton( skeletons, joints ) {
			...
			for ( i = 0; i < skeletons.length; i ++ ) {
				...
				if ( hasNode( skeleton ) ) {
					...
					// handle case where the skeleton refers to the visual g_scene (#13335)
		...
		function buildBoneHierarchy( root, joints, boneData ) {
			...
			// setup bone data from visual g_scene
			...
			root.traverse( function ( object ) {
				...
				if ( object.isBone === true ) {
					...
					if ( boneInverse === undefined ) {
						...
						// Unfortunately, there can be joints in the visual g_scene that are not part of the
