...
var MMDLoader = ( function () {
	...
	function initBones( mesh ) {
		...
		// now the bones are part of the g_scene graph and children of the skinned mesh.
	...
	CubicBezierInterpolation.prototype = Object.assign( Object.create( Interpolant.prototype ), {
		...
		_calculate: function ( x1, x2, y1, y2, x ) {
			 ...
			 *      ( 0 <= t <= 1 )
			 *
			 * MMD uses Cubic Bezier curves for bone and g_camera animation interpolation.
