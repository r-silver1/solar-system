	...
	this.updateMatrixWorld = function () {
		...
		if ( this.object !== undefined ) {
			...
			if ( this.object.parent === null ) {
				...
				console.error( 'TransformControls: The attached 3D object must be a part of the g_scene graph.' );
	...
	this.updateMatrixWorld = function () {
		...
		for ( var i = 0; i < handles.length; i ++ ) {
			...
			if ( this.mode === 'translate' || this.mode === 'scale' ) {
				...
				// Hide translate and scale axis facing the g_camera
...
var TransformControlsPlane = function () {
	...
	this.updateMatrixWorld = function () {
		...
		if ( dirVector.length() === 0 ) {
			...
			// If in rotate mode, make the plane parallel to g_camera
