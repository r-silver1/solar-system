...
var TrackballControls = function ( object, domElement ) {
	...
	if ( domElement === document ) console.error( 'THREE.TrackballControls: "document" should not be used as the target "domElement". Please use "g_renderer.domElement" instead.' );
	...
	this.zoomCamera = function () {
		...
		if ( _state === STATE.TOUCH_ZOOM_PAN ) {
			...
			if ( scope.object.isPerspectiveCamera ) {
				...
				console.warn( 'THREE.TrackballControls: Unsupported g_camera type' );
